...
Output strictly valid JSON matching this schema without markdown formatting (REPLACE the placeholders with your actual answers):
{
  ...
  "repeatedMistakes": ["<Mistake 1>", "<Mistake 2>", "<Mistake 3>"],
  ...
  "studyPlan": [
    { "day": "Day 1", "topic": "<Topic Name>", "objective": "<Actionable objective description>" },
...
${Object.entries(context.patternDistribution)
